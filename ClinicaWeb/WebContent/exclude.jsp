...
<body>
	...
	<section id="secondary_bar">
		...
		<div class="breadcrumbs_container">
			<article class="breadcrumbs"> <a href="admin.jsp"> Medical Clinic Puccamp </a> <div class="breadcrumb_divider"></div> <a class="current">Excluir Usuário</a></article> 
		</div>
...
<article class="module width_full">
			<header><h2>Exclusão de Conta</h2></header>
			...
			<%@page import = "javax.sql.*" %>
				...
				try{
					...
					st.executeUpdate("UPDATE acesso SET Ativo = 0 WHERE Id='" + session.getAttribute("id")+ "'");
